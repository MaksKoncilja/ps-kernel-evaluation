...
# Default: let JAX use GPU if the installed jaxlib supports it.
# Set FORCE_JAX_CPU=1 before import if you explicitly want CPU.
if os.environ.get("FORCE_JAX_CPU", "0") == "1":
    os.environ["JAX_PLATFORMS"] = "cpu"
    os.environ["JAX_PLATFORM_NAME"] = "cpu"
else:
    # Do not force CPU from inside Python. Respect external JAX settings.
